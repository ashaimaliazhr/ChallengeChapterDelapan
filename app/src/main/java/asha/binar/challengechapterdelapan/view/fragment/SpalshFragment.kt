...
import asha.binar.challengechapterdelapan.databinding.FragmentSpalshBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            viewModelUser.getEmail().observe(viewLifecycleOwner) {
                ...
                if (it != ""){
                    Navigation.findNavController(view).navigate(R.id.action_spalshFragment_to_homeFragment)
                }else{
                    Navigation.findNavController(view).navigate(R.id.action_spalshFragment_to_loginFragment)
                }
            }
        }, 3000)
